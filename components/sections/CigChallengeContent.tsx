...
import { CIG_CHALLENGE } from "@/lib/content";

export default function CigChallengeContent() {
  return (
    <section id="cigs" className="py-24 md:py-32 bg-bone">
      <div className="max-w-6xl mx-auto px-5 md:px-8">
        <SectionHeader
          eyebrow="Bonus — The Cig Challenge"
          title="One pack. One job. Smoke it or pay the price."
        />

        <div className="grid md:grid-cols-12 gap-10 md:gap-16 items-start">
          {/* Blurb + penalty callout */}
          <motion.div
            ...
            <div className="rounded-2xl border border-clay/40 bg-clay/10 px-5 md:px-7 py-5 flex items-center justify-between gap-4">
              <div className="min-w-0">
                ...
                <p className="text-[13px] md:text-[14px] text-ink/70 leading-relaxed">
                  Per unsmoked cig at closing. Pack size: {CIG_CHALLENGE.packSize}.
                  Worst case: −{CIG_CHALLENGE.packSize * CIG_CHALLENGE.penaltyPerCig}.
                </p>
              </div>
              <span className="font-display text-3xl md:text-4xl font-semibold text-clay tabular-nums shrink-0">
                −{CIG_CHALLENGE.penaltyPerCig}
              </span>
            </div>
          </motion.div>
