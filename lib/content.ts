...
export const MATCHUPS: EventMatchup[] = [
  ...
  },
  {
    ...
    tier: "Minor",
    format: "Every camper runs the bases. Cumulative tribe time wins.",
    notes: [
      "All members of each tribe run — no sitting out. Touch every bag or the run doesn't count.",
      "Times are stacked end-to-end into a single tribe clock; lowest aggregate wins.",
      "Slowest tribe wears the wig for the next chug-off.",
    ],
    rounds: [
      {
        name: "Cumulative Clock",
        matches: [
          { time: "2:00 PM", label: "Heat 1", home: "🎓 Class Clowns — full roster" },
          { time: "2:08 PM", label: "Heat 2", home: "🎲 Snake Eyes — full roster" },
          { time: "2:16 PM", label: "Heat 3", home: "🗽 Liberty Goons — full roster" },
          { time: "2:24 PM", label: "Heat 4", home: "🔥 Burn Unit — full roster" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    seedingNote: SEEDING_FROM_FLIP_CUP,
    notes: [
      "Each match: 4 reps per tribe in the pit at once. Last tribe with a player standing wins.",
      "Hits below the knee. Above the knee, you're out. Catch a ball cleanly, thrower is out.",
      "Runs in parallel with Cornhole — pick gaga reps separate from your cornhole pair.",
    ],
    rounds: [
      {
        name: "Round Robin",
  ...
  },
  {
    ...
    tier: "Minor",
    format: "Doubles — 2 reps per tribe. Single-elim bracket. Runs parallel to Gaga.",
    seedingNote: SEEDING_FROM_FLIP_CUP,
    notes: [
      "Two boards in play — semis run simultaneously.",
      "First to 15, win by 1. Cancellation scoring.",
      "Different reps from each tribe than Gaga — no doubling up.",
    ],
    rounds: [
      {
        name: "Semifinals (parallel)",
        matches: [
          { time: "4:00 PM", label: "Semi 1", home: "🎓 Class Clowns", away: "🔥 Burn Unit", venue: "Board A" },
          { time: "4:00 PM", label: "Semi 2", home: "🎲 Snake Eyes", away: "🗽 Liberty Goons", venue: "Board B" },
        ],
      },
      {
        name: "Placement",
        matches: [
          { time: "4:30 PM", label: "Bronze", home: "Loser Semi 1", away: "Loser Semi 2", venue: "Board A" },
          { time: "4:45 PM", label: "FINAL", home: "Winner Semi 1", away: "Winner Semi 2", venue: "Board A" },
        ],
      },
    ],
  },
